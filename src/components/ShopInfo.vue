<template>
    <div class="shop" >
        <img class="shop__item__img" :src="item.imgUrl">
        <div 
        :class="{'shop__content':true ,'shop__content--borderd':hideBorder ? false : true}"
        >
            ...
            <p class="shop__content__highlight">{{ item.solgan }}</p>
        </div>
    </div>
</template>
